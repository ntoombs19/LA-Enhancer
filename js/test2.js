...
/*** Main ***************************/
	$.getScript(scriptURL + "js/resources2.js", function() {
...
/*** Page Loading and Data Mining ***/
	...
	function createNewTable(column, direction) {
	    ...
	    reports().order(column + " " + direction).each(function(record, recordnumber) {
	        ...
	        var dot = "<td><img src='https://dsen.innogamescdn.com/8.31.1/24230/graphic/dots/" + record.dot + ".png?bb7c6'></td>";
	        var loot = (record.loot != null) ? "<td><img src='https://dsen.innogamescdn.com/8.31.1/24230/graphic/max_loot/" + record.loot + ".png?c2b58'></td>" : "<td></td>";
